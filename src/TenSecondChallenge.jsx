function TenSecondChallenge({ debug = false, autoWin = false }) {
  ...
  const [hasTriedToday, setHasTriedToday] = useState(false);   // <- the only lock we keep
  ...
  useEffect(() => {
    const tried = typeof window !== "undefined"
...
<h2 className="text-2xl md:text-3xl>Stop the timer on 10:00 exactly to win a <strong>Free Clean</strong></h2>
