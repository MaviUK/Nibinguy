...
# Generate a timestamped filename for the updated script
timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
filename = f"/mnt/data/NiBinGuyLandingPage_Updated_{timestamp}.jsx"

# Define the full updated script with the new section included
full_script = '''import React, { useState, useEffect } from "react";
    ...
    <div className="min-h-screen bg-black text-white font-sans">
      ...
      <section className="py-16 px-6 bg-zinc-900">
        ...
        <div className="grid md:grid-cols-3 gap-6 text-center">
          <div className="bg-zinc-800 p-6 rounded-2xl shadow-xl"><h3 className="text-xl font-bold mb-2">Domestic Bins</h3><p>We clean green, black, and blue bins right outside your home.</p></div>
          <div className="bg-zinc-800 p-6 rounded-2xl shadow-xl"><h3 className="text-xl font-bold mb-2">Commercial Contracts</h3><p>Need regular bin cleaning? We handle your business waste too.</p></div>
          <div className="bg-zinc-800 p-6 rounded-2xl shadow-xl"><h3 className="text-xl font-bold mb-2">Eco-Friendly Process</h3><p>We use biodegradable products and minimal water waste.</p></div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-black">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div><h3 className="text-xl font-semibold mb-2">Local & Trusted</h3><p>We're based in Bangor and proud to serve the local community.</p></div>
          <div><h3 className="text-xl font-semibold mb-2">Flexible Plans</h3><p>Choose from one-off or monthly cleans.</p></div>
          <div><h3 className="text-xl font-semibold mb-2">Affordable Pricing</h3><p>Starting from just £5 per bin. No hidden fees.</p></div>
          <div><h3 className="text-xl font-semibold mb-2">Fully Insured</h3><p>You're covered. We’re fully licensed and insured.</p></div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-zinc-900">
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto text-left">
          <div><h3 className="text-xl font-semibold mb-2">Prevent Nasty Odours</h3><p>Bins can start to smell unpleasant fast. Regular cleaning eliminates those foul smells at the source.</p></div>
          <div><h3 className="text-xl font-semibold mb-2">Stop Bacteria Buildup</h3><p>Leftover waste can attract harmful bacteria. Professional bin cleaning keeps your home environment safer and more hygienic.</p></div>
          <div><h3 className="text-xl font-semibold mb-2">Deter Insects & Vermin</h3><p>Flies, maggots, and rodents are drawn to dirty bins. Keep them away by keeping your bin spotless.</p></div>
          <div><h3 className="text-xl font-semibold mb-2">Protect Your Family</h3><p>A clean bin reduces exposure to germs and pathogens, helping keep your household healthier.</p></div>
        </div>
      </section>
